...
class geekMail
{
    ...
    public function bcc($bcc, $limit = '')
    {
        ...
        if (($this->_getProtocol() == 'smtp') or ( ($this->_bccBatchMode) && ((count($bcc)) > $this->_bccBatchSize))) {
            $this->_bccArray = $bcc;
        } else {
    ...
    public function send()
    {
        ...
        if ((!isset($this->_recipients)) and ( !isset($this->_headers['To'])) and ( !isset($this->_bccArray)) and ( !isset($this->_headers['Bcc'])) and ( !isset($this->_headers['Cc']))) {
    ...
    {
        $this->_smtpConnect = fsockopen($this->_smtpHost, $this->_smtpPort, $errno, $errstr, $this->_smtpTimeout);
    ...
    {
        $this->_protocol = strtolower($_protocol);
    }
     ...
     * Set SMTP Username.
     */
    public function setSmtpUser($_smtpUser)
    {
